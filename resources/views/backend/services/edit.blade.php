        ...
        <div class="page-content">
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-xl-9">
                        <div class="card">
                            <form action="{{ route('backend.services.update',$service->id) }}"
                                ...
                                <div class="card-body">
                                    <div class="col-12">
                                        <div
                                            ...
                                            <h4 class="mb-sm-0">@lang('backend.services'): #{{ $service->id }}</h4>
                                        </div>
                                    </div>
                                    ...
                                    <div class="tab-content p-3 text-muted">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <img src="{{ asset($service->photo) }}" class="form-control mb-2"
                                                 width="100%">
