                    ...
                    <div class="card-body">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">@lang('backend.services'):</h4>
                        ...
                        <table id="datatable" class="table table-striped table-bordered dt-responsive nowrap"
                            ...
                            @foreach($services as $service)
                                <tr>
                                    ...
                                    <td class="text-center"><img src="{{ asset($service->photo) }}" width="100" height="50">
                                    <td class="text-center">{{ $service->name }}</td>
                                    <td>{{ date('d.m.Y H:i:s',strtotime($service->created_at))}}</td>
                                    <td class="text-center">
                                        <a href="{{ route('backend.statusService',['id'=>$service->id]) }}"
