...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
    ...
    <tr style="margin-bottom: 43px;">
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                ...
                ">
                        <p style="margin: 0">
                           @lang('backend.dear'), {{ settings('mail_receiver') }}
                        </p>
                       <p>@lang('backend.name'): {{ $data['name'] }}</p>
                    </td>
                </tr>
                <tr>
                    <td bgcolor="#ffffff" align="left" style="
        ...
        <td bgcolor="#f4f4f4" align="center" style="padding: 30px 10px 0px 10px;">
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;margin-bottom: 43px;">
                ...
                ">
                        ...
                        <p style="margin: 0">
                            <a href="{{ route('frontend.contact-us-page') }}" target="_blank" style="color: #D6B98D"> Abonəlikdən imtina et.</a>
                        </p>
                    </td>
                </tr>
            </table>
