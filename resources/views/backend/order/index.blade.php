                    ...
                    <div class="card-body">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">@lang('backend.create-order'):</h4>
                            </div>
                        </div>
                            ...
                            @foreach($orders as $order)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <span
                                            class="mdi {{ ($order->read_status == 0) ? 'mdi-eye-off' : 'mdi-eye' }}"> {{ ($order->read_status == 0) ? __('backend.unread') : __('backend.read') }}</span>
                                    </td>
                                    ...
                                    <td class="text-center">
                                        <a class="btn btn-primary"
                                           href="{{ route('backend.orderRead',['id'=>$order->id]) }}">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a class="btn btn-danger"
                                           href="{{ route('backend.delOrder',['id'=>$order->id]) }}">
